...
if(isset($_POST['mail'])) {
     // 
    $email_to = "ezequiel.bandap@gmail.com";
    ...
    $lastname = $_POST['lastname']; // requerido
    $email_from = $_POST['mail']; // no requerido 
...
//Este es el cuerpo del mensaje tal y como llegará al correo
    ...
    $email_message .= "Asunto: ".clean_string($lastname)."\n";
    $email_message .= "Correo: ".clean_string($mail)."\n";
